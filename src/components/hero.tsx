...
export default function Hero() {
  ...
  return (
    <section
      className="relative hidden overflow-hidden bg-primary-foreground bg-cover bg-center bg-no-repeat object-contain dark:bg-gray-900 md:block"
      // style={{
      //   backgroundImage: `url(${billboardImage?.imageUrl})`,
      // }}
    >
      <div className="mx-auto my-8 flex max-w-2xl flex-col items-center rounded-lg bg-white/90 py-4 text-center shadow-2xl backdrop-blur-3xl dark:bg-black/90 sm:my-14 sm:py-6 md:my-20 md:py-8">
